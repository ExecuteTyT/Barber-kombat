    ...
    <InfoSheet open={open} onClose={onClose} title="Прогресс и премии">
      ...
      <InfoSection title="Из чего складывается рейтинг">
        <p>
          ...
          Считается он за весь месяц и <strong>не равен</strong> сумме или среднему твоих
          дневных баллов — поэтому может отличаться от того, что видишь в рейтинге за день.
        </p>
      </InfoSection>
