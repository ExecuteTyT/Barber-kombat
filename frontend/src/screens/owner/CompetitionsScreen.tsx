            ...
            <div className="bk-card overflow-hidden">
              ...
              <div className="border-t border-[var(--bk-border)] px-3 py-2">
                <p className="text-[10px] leading-relaxed text-[var(--bk-text-dim)]">
                  Баллы (макс. 100) складываются из 5 показателей. Лучший по каждому получает максимум, остальные — пропорционально. Это балл за день — за месяц считается отдельно (вкладка «Премии»).
                </p>
              </div>
            ...
            <div className="bk-card overflow-hidden">
              <div className="px-3 pb-1 pt-3">
                ...
                <p className="mt-0.5 text-[10px] leading-relaxed text-[var(--bk-text-dim)]">
                  Балл месяца (0–100) считается так же, как дневной — по тем же 5
                  показателям, но за весь месяц с 1-го числа. Это <b>не сумма</b> дневных
        ...
        {tab === 'kombat' ? (
          <>
            <InfoSection title="Система баллов">
              ...
              100) складывается из всех показателей. Это балл <b>за один день</b> —
              он обнуляется в полночь. Итог за месяц считается отдельно, см. вкладку «Премии».
            </InfoSection>
          ...
          <>
            <InfoSection title="Балл за месяц">
              Считается так же, как в «Рейтинге дня»: те же 5 показателей,
              нормализация 0–100 относительно филиала, те же веса. Разница только в
              периоде — берётся весь месяц, а не один день. Балл месяца (0–100) — это
              не сумма дневных баллов, а отдельный расчёт по итогам месяца.
            </InfoSection>
            <InfoSection title="Почему отличается от дневного">
              Дневной балл — соревнование за один день, обнуляется в полночь.
              Месячный — отдельный зачёт за весь месяц. Барбер может быть лучшим
              сегодня, но не лучшим за месяц (и наоборот) — это нормально.
            </InfoSection>
            <InfoSection title="Пороги и премия">
              Администратор задаёт пороги по баллу (например, 60) и премию за каждый.
              Когда балл месяца достигает порога — начисляется премия. Несколько
              порогов за месяц суммируются.
            </InfoSection>
            <InfoSection title="Допуск и сброс">
              Чтобы получить премию, нужно отработать минимум рабочих дней за месяц —
              иначе барбер не допускается. 1-го числа балл и премии обнуляются.
            </InfoSection>
          </>
        )}
      </InfoSheet>
